...
""",
    thermo = NASA(
        polynomials = [
            NASAPolynomial(coeffs=[3.59505,0.042073,2.30238e-05,-6.33518e-08,2.95334e-11,-58618.8,10.8848], Tmin=(10,'K'), Tmax=(826.6,'K')),
            NASAPolynomial(coeffs=[5.68604,0.0516792,-3.02021e-05,8.44419e-09,-9.12027e-13,-58618.8,-2.88099], Tmin=(826.6,'K'), Tmax=(3000,'K')),
        ],
        Tmin = (10,'K'),
        Tmax = (3000,'K'),
    ),
