...
p. 264
Calculations done at the RCCSD(T)/6-311G(3df,2p)//B3LYP/6-311G(d,p) level of theoty
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: J. Hahn, K. Luther and J. Troe
