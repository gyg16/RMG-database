...
entry(
    ...
    kinetics = ArrheniusEP(
        ...
        Tmin = (300, 'K'),
        Tmax = (2000, 'K'),
        comment = '\n\nDegeneracy not recalculated\n\nConverted to training reaction from rate rule: C/H3/Ct;InChI=1S/NO3/c2-1(3)4',
    ),
    rank = 1,
...
entry(
    ...
    kinetics = ArrheniusEP(
        ...
        Tmin = (300, 'K'),
        Tmax = (2000, 'K'),
        comment = 'Added by Beat Buesser, value for reaction: HNO2 + H = H2 + NO2 (B&D #41a) in \'Gas-Phase Combustion Chemistry\' (ISBN: 978-1-4612-7088-1), chapter 2, \'Combustion Chemistry of Nitrogen\', Anthony M. Dean, Joseph W. Bozzelli",\n\nDegeneracy not recalculated\n\nConverted to training reaction from rate rule: N5dc/H/NonDeOO;H_rad',
    ),
    rank = 1,
...
entry(
    ...
    kinetics = ArrheniusEP(
        ...
        Tmin = (300, 'K'),
        Tmax = (2000, 'K'),
        comment = 'Added by Beat Buesser, value for reaction: HNO2 + O = OH + NO2 (B&D #41b) in \'Gas-Phase Combustion Chemistry\' (ISBN: 978-1-4612-7088-1), chapter 2, \'Combustion Chemistry of Nitrogen\', Anthony M. Dean, Joseph W. Bozzelli",\n\nDegeneracy not recalculated\n\nConverted to training reaction from rate rule: N5dc/H/NonDeOO;O_atom_triplet',
    ),
    rank = 1,
    shortDesc = u"""Added by Beat Buesser""",
    longDesc = 
...
entry(
    ...
    kinetics = ArrheniusEP(
        ...
        Tmin = (300, 'K'),
        Tmax = (2000, 'K'),
        comment = 'Added by Beat Buesser, value for reaction: HNO2 + OH = H2O + NO2 (B&D #41c) in \'Gas-Phase Combustion Chemistry\' (ISBN: 978-1-4612-7088-1), chapter 2, \'Combustion Chemistry of Nitrogen\', Anthony M. Dean, Joseph W. Bozzelli",\n\nDegeneracy not recalculated\n\nConverted to training reaction from rate rule: N5dc/H/NonDeOO;O_pri_rad',
    ),
    rank = 1,
    shortDesc = u"""Added by Beat Buesser""",
    longDesc = 
...
entry(
    ...
    kinetics = ArrheniusEP(
        ...
        Tmin = (300, 'K'),
        Tmax = (2000, 'K'),
        comment = 'Added by Beat Buesser, value for reaction: HNO2 + CH3 = NO2 + CH4 (B&D #41d) in \'Gas-Phase Combustion Chemistry\' (ISBN: 978-1-4612-7088-1), chapter 2, \'Combustion Chemistry of Nitrogen\', Anthony M. Dean, Joseph W. Bozzelli",\n\nDegeneracy not recalculated\n\nConverted to training reaction from rate rule: N5dc/H/NonDeOO;C_methyl',
    ),
    rank = 1,
    shortDesc = u"""Added by Beat Buesser""",
    longDesc = 
...
entry(
    ...
    kinetics = ArrheniusEP(
        ...
        Tmin = (300, 'K'),
        Tmax = (2000, 'K'),
        comment = 'Added by Beat Buesser, value for reaction: HNO2 + NH2 = NH3 + NO2 (B&D #41e) in \'Gas-Phase Combustion Chemistry\' (ISBN: 978-1-4612-7088-1), chapter 2, \'Combustion Chemistry of Nitrogen\', Anthony M. Dean, Joseph W. Bozzelli",\n\nDegeneracy not recalculated\n\nConverted to training reaction from rate rule: N5dc/H/NonDeOO;NH2_rad',
    ),
    rank = 1,
    shortDesc = u"""Added by Beat Buesser""",
    longDesc = 
