...
entry(
    ...
    longDesc = 
u"""
Taken from entry: [102] Arai, H.; Nagai, S.; Hatada, M.; Radiat. Phys. Chem. 1981, 17, 211.
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: [94] Baulch, D.L.; Cobos, C.J.; Cox, R.A.; Frank, P.; Hayman, G,; Just, T.; Kerr, J.A.; Murrells, T.; Pilling, M.J.; 
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: [104] Nam, G.-J.; Xia, W.; Park, J.; Lin, M. Phys. Chem. A 2000, 104, 1233.	
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: [105] Wang, B.; Hou, H.; Gu, Y. Phys. Chem. A 1999, 103, 8021.
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: CH3CH2 + CO = CH3CH2CO
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: CH3CH2CH2 + CO = CH3CH2CH2CO
MRH CBS-QB3 calculations with 1D hindered rotor corrections [MRHCBSQB31DHR]_.
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: CH3CHCH3 + CO = CH3CH(CO)CH3
MRH CBS-QB3 calculations with 1D hindered rotor corrections [MRHCBSQB31DHR]_.
