...
entry(
    ...
    longDesc = 
u"""
Taken from entry: MRH CBS-QB3 calculations for the reaction CH3-CH(OO)-CH=CH2 => CH2=CH-CH=CH2 + HO2
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: MRH approximation for the general R2OO_2H_HDe node
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: MRH CBS-QB3 calculations for the reaction CH3-CH(OO)-OH => CH3-CH=O + HO2
...
entry(
    ...
    longDesc = 
u"""
Taken from entry: MRH approximation for the general OCOO node
